...
| 문서 | 용도 |
|------|------|
| [system_specification_v1.md](system_specification_v1.md) | WSS-MQTT API 사양 (프로토콜, Envelope, 인증, 시퀀스) |
...
| [TGU_RPC_SDK_DEVELOPMENT_PLAN.md](TGU_RPC_SDK_DEVELOPMENT_PLAN.md) | TGU RPC SDK 아키텍처·개발 계획 (진행 상황은 루트 [TODO.md](../TODO.md) 참고) |
