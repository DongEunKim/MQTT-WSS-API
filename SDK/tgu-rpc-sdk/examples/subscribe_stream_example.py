...
TGU/Mock이 WMO/.../stream/{api} 토픽에 발행해야 동작.

Usage:
    터미널 1: python SDK/examples/run_mock_server.py  # 또는 TGU 시뮬레이터
    터미널 2: python SDK/tgu-rpc-sdk/examples/subscribe_stream_example.py [--async]
