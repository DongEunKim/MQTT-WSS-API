...
Usage:
    ...
    # TCP 연결 (기본)
    python SDK/client/python/wss-mqtt-client/examples/mqtt_subscriber.py

    # WebSocket 연결
    MQTT_URL=ws://localhost:9001 python SDK/client/python/wss-mqtt-client/examples/mqtt_subscriber.py
